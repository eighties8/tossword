...
export const VALID_WORDS = new Set([
  ...
  "build", "built", "buyer", "cable", "calif", "canoe", "carry", "catch", "cause", "chain", "chair",
  "chart", "chase", "cheap", "check", "chest", "chief", "child", "china", "chino", "chose", "civil",
  "claim", "class", "clean", "clear", "click", "climb", "clock", "clone", "close", "coach", "coast",
  ...
  "exile", "exist", "exits", "extra", "fable", "faced",
  "fairy", "faith", "false", "fancy", "fangs", "farce", "fatal", "fault", "fauna",
  ...
  "throb", "throw", "thuds", "thugs", "thumb", "thump", "thyme", "tiara", "tibia",
  ...
  "vomit", "voter", "vouch", "vowed", "vowel", "vying", "wacky", "wafer", "wafts",
  "waged", "wager", "wages", "wagon", "waifs", "wails", "waist", "waits", "waive", "waken",
  "wakes", "wales", "walks", "walls", "wands", "wanes", "wants", "wards",
  "wares", "warms", "warns", "warps", "warts", "wasps", "waste", "watch", "water", "waver",
  "waxen", "waxes", "weary", "weave", "wedge", "weeds", "month",
  "weedy", "weeks", "weeps", "weepy", "weigh", "weird", "wells", "welsh", "wench",
